...
public class UserMain extends JDialog {
	...
	private JPanel panelUserAptitudeQuiz;
	...
	public UserMain() {
		...
		getContentPane().add(getPanelUserAptitudeQuiz());
	...
	private JPanel getPanelUserAptitudeQuiz() {
		if (panelUserAptitudeQuiz == null) {
			panelUserAptitudeQuiz = new JPanel();
			panelUserAptitudeQuiz.setBounds(180, 10, 500, 420);
			panelUserAptitudeQuiz.setLayout(null);
			panelUserAptitudeQuiz.add(getBtnQuiziNext());
			panelUserAptitudeQuiz.add(getLbQuizResult2());
			panelUserAptitudeQuiz.add(getLbQuizResult1());
			panelUserAptitudeQuiz.add(getLbQuiz());
			panelUserAptitudeQuiz.setVisible(false);
		}
		return panelUserAptitudeQuiz;
	}
